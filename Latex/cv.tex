...
\newcommand*{\researchgatesocialsymbol}
                                               {{\small\faResearchgate}~}
\newcommand*{\googlescholarsocialsymbol}
                                               {{\small\faGoogleScholar}~}
...
\address{Silcherstr. 2}{89231 Neu-Ulm}{Germany}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
...
\cventry{}{Sathiya Ramesh}{}{Masters Advisor}{R\&D Robotics, Robert Bosch GmbH}{}
